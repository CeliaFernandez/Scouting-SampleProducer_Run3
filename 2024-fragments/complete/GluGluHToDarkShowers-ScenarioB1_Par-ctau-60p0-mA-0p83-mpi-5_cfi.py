...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.8333333333333334 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.154 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.154 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.615 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.0276 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:tau0 = 1.51e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-60p0-mA-0p83-mpi-5_cfi.py
