...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.62 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.24 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.239 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.557 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.00421 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:tau0 = 3.15e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-0p25-mA-0p62-mpi-6p20_cfi.py
