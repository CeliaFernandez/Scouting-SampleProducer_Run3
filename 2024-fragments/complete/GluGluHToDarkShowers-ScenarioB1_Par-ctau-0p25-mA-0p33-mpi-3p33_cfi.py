...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.3333333333333333 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.492 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.458 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.038 91 211 -211              ! A' -> pi+ pi-",
            "999999:tau0 = 1.2e-08                            ! proper lifetime, in mm",
            ...
            "4900111:tau0 = 0.25                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-0p25-mA-0p33-mpi-3p33_cfi.py
