...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 4              ! dark confinement scale",
            "HiddenValley:pTminFSR = 4.4        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 4.112308833710375          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 4.137691166289625          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 1                        ! Setting pion Mass",
            "4900211:m0 = 1                        ! Setting pion Mass",
            "4900221:m0 = 4                        ! Setting eta Mass",
            "4900113:m0 = 4                       ! Setting rho Mass",
            "4900213:m0 = 4                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.45 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.424 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.416 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.138 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.0169 91 211 -211 111              ! A' -> pi+ pi- pi0",
            ...
            "4900111:tau0 = 0.0011                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-0p25-mA-0p45-mpi-1_cfi.py
