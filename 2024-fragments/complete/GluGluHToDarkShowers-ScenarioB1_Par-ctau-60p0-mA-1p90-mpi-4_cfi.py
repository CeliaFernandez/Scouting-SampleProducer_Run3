...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 1.9 0.001 0. 0. 0.        ! dark photon A'",
            ...
            "999999:tau0 = 1.07e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-60p0-mA-1p90-mpi-4_cfi.py
