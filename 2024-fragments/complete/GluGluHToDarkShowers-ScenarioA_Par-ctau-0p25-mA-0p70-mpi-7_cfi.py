...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 28              ! dark confinement scale",
            "HiddenValley:pTminFSR = 30.800000000000004        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 28.786161835972624          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 28.963838164027376          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 7                        ! Setting pion Mass",
            "4900211:m0 = 7                        ! Setting pion Mass",
            "4900221:m0 = 28                        ! Setting eta Mass",
            "4900113:m0 = 28                       ! Setting rho Mass",
            "4900213:m0 = 28                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.7 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.144 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.144 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.704 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.00521 91 211 -211 111              ! A' -> pi+ pi- pi0",
            ...
            "4900111:tau0 = 0.000157                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-0p25-mA-0p70-mpi-7_cfi.py
