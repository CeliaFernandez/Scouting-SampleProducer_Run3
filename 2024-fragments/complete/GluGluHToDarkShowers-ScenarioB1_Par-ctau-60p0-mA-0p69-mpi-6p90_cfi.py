...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.69 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.149 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.148 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.705 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.00508 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:tau0 = 1.75e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-60p0-mA-0p69-mpi-6p90_cfi.py
