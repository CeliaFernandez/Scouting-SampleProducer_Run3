...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 10.8              ! dark confinement scale",
            "HiddenValley:pTminFSR = 11.880000000000003        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 11.103233851018013          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 11.17176614898199          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 2.7                        ! Setting pion Mass",
            "4900211:m0 = 2.7                        ! Setting pion Mass",
            "4900221:m0 = 10.8                        ! Setting eta Mass",
            "4900113:m0 = 10.8                       ! Setting rho Mass",
            "4900213:m0 = 10.8                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.9 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.264 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.263 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.425 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.0265 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "9900015:addChannel = 1 0.00633 91 211 -211 111 111              ! A' -> pi+ pi- pi0 pi0",
            "9900015:tau0 = 100.0                            ! proper lifetime, in mm",
            ...
            "4900111:tau0 = 0.000407                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-100-mA-0p90-mpi-2p70_cfi.py
