...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "4900221:addChannel = 1 6.57e-12 91 999999 999999              ! eta -> A' A'",
            "4900221:addChannel = 1 1.0 91 4900211 999999              ! eta -> pi2 A'",
            "4900221:tau0 = 3.0                            ! proper lifetime, in mm",
            "4900111:onMode = 0",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioB2_Par-ctau-3p0-mA-2p10-mpi-4_cfi.py
