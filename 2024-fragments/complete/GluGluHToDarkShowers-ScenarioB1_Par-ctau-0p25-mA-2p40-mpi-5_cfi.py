...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 2.4 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.0783 91 1 -1              ! A' -> d dbar",
            "999999:addChannel = 1 0.313 91 2 -2              ! A' -> u ubar",
            "999999:addChannel = 1 0.0783 91 3 -3              ! A' -> s sbar",
            "999999:addChannel = 1 0.0602 91 4 -4              ! A' -> c cbar",
            "999999:addChannel = 1 0.235 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.235 91 13 -13              ! A' -> mu+ mu-",
            "999999:tau0 = 7.969999999999999e-10                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-0p25-mA-2p40-mpi-5_cfi.py
