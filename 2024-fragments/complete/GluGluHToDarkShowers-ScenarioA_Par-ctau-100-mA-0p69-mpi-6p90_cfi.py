...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 27.6              ! dark confinement scale",
            "HiddenValley:pTminFSR = 30.360000000000003        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 28.374930952601588          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 28.550069047398416          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 6.9                        ! Setting pion Mass",
            "4900211:m0 = 6.9                        ! Setting pion Mass",
            "4900221:m0 = 27.6                        ! Setting eta Mass",
            "4900113:m0 = 27.6                       ! Setting rho Mass",
            "4900213:m0 = 27.6                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.69 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.149 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.148 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.705 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.00508 91 211 -211 111              ! A' -> pi+ pi- pi0",
            ...
            "4900111:tau0 = 0.00015900000000000002                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-100-mA-0p69-mpi-6p90_cfi.py
