...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 13.333333333333334              ! dark confinement scale",
            "HiddenValley:pTminFSR = 14.666666666666668        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 13.707696112367916          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 13.792303887632086          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 3.3333333333333335                        ! Setting pion Mass",
            "4900211:m0 = 3.3333333333333335                        ! Setting pion Mass",
            "4900221:m0 = 13.333333333333334                        ! Setting eta Mass",
            "4900113:m0 = 13.333333333333334                       ! Setting rho Mass",
            "4900213:m0 = 13.333333333333334                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.3333333333333333 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.492 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.458 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.038 91 211 -211              ! A' -> pi+ pi-",
            ...
            "4900111:tau0 = 0.000329                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-0p25-mA-0p33-mpi-3p33_cfi.py
