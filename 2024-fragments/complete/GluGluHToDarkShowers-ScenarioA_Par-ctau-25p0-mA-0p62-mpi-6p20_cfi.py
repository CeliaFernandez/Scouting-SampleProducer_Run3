...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 24.8              ! dark confinement scale",
            "HiddenValley:pTminFSR = 27.280000000000005        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 25.496314769004325          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 25.653685230995677          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 6.2                        ! Setting pion Mass",
            "4900211:m0 = 6.2                        ! Setting pion Mass",
            "4900221:m0 = 24.8                        ! Setting eta Mass",
            "4900113:m0 = 24.8                       ! Setting rho Mass",
            "4900213:m0 = 24.8                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 0.62 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.24 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.239 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.557 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.00421 91 211 -211 111              ! A' -> pi+ pi- pi0",
            ...
            "4900111:tau0 = 0.000177                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-25p0-mA-0p62-mpi-6p20_cfi.py
