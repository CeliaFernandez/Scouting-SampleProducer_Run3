...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 4.8              ! dark confinement scale",
            "HiddenValley:pTminFSR = 5.28        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 4.93477060045245          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 4.9652293995475505          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 1.2                        ! Setting pion Mass",
            "4900211:m0 = 1.2                        ! Setting pion Mass",
            "4900221:m0 = 4.8                        ! Setting eta Mass",
            "4900113:m0 = 4.8                       ! Setting rho Mass",
            "4900213:m0 = 4.8                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "999999:all = GeneralResonance void 1 0 0 0.4 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.451 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.436 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.105 91 211 -211              ! A' -> pi+ pi-",
            "999999:tau0 = 9.17e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-0p25-mA-0p40-mpi-1p2_cfi.py
