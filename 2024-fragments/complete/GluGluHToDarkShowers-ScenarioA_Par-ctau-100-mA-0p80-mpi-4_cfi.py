...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "9900015:all = GeneralResonance void 1 0 0 0.8 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.14 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.14 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.676 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.0507 91 211 -211 111              ! A' -> pi+ pi- pi0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-100-mA-0p80-mpi-4_cfi.py
