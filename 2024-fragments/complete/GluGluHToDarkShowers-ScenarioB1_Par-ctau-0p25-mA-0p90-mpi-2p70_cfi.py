...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 0.9 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.264 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.263 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.425 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.0265 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:addChannel = 1 0.00633 91 211 -211 111 111              ! A' -> pi+ pi- pi0 pi0",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-0p25-mA-0p90-mpi-2p70_cfi.py
