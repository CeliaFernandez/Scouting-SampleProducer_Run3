...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "9900015:all = GeneralResonance void 1 0 0 3.3333333333333335 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.0645 91 1 -1              ! A' -> d dbar",
            "9900015:addChannel = 1 0.258 91 2 -2              ! A' -> u ubar",
            "9900015:addChannel = 1 0.0645 91 3 -3              ! A' -> s sbar",
            "9900015:addChannel = 1 0.227 91 4 -4              ! A' -> c cbar",
            "9900015:addChannel = 1 0.193 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.193 91 13 -13              ! A' -> mu+ mu-",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-25p0-mA-3p33-mpi-10_cfi.py
