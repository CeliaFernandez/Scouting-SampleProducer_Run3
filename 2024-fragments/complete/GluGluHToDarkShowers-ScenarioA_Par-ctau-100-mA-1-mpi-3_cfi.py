...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "4900101:m0 = 12.336926501131124          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 12.413073498868876          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 3.0                        ! Setting pion Mass",
            "4900211:m0 = 3.0                        ! Setting pion Mass",
            "4900221:m0 = 12.0                        ! Setting eta Mass",
            "4900113:m0 = 12.0                       ! Setting rho Mass",
            "4900213:m0 = 12.0                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 1.0 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.293 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.293 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.125 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.196 91 321 -321              ! A' -> K+ K-",
            "9900015:addChannel = 1 0.0215 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "9900015:addChannel = 1 0.00723 91 211 -211 211 -211              ! A' -> pi+ pi- pi+ pi-",
            "9900015:addChannel = 1 0.0177 91 211 -211 111 111              ! A' -> pi+ pi- pi0 pi0",
            ...
            "4900111:tau0 = 0.000366                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
...
# GluGluHToDarkShowers-ScenarioA_Par-ctau-100-mA-1-mpi-3_cfi.py
