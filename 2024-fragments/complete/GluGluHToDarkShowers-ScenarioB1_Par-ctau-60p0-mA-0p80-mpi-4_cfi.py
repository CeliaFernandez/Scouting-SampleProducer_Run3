...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 16              ! dark confinement scale",
            ...
            "4900221:m0 = 16                        ! Setting eta Mass",
            "4900113:m0 = 16                       ! Setting rho Mass",
            "4900213:m0 = 16                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "999999:all = GeneralResonance void 1 0 0 0.8 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.14 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.14 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.676 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.0507 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:tau0 = 1.43e-09                            ! proper lifetime, in mm",
...
# GluGluHToDarkShowers-ScenarioB1_Par-ctau-60p0-mA-0p80-mpi-4_cfi.py
