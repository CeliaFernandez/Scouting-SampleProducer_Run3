...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "9900015:all = GeneralResonance void 1 0 0 0.25 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.562 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.413 91 13 -13              ! A' -> mu+ mu-",
...
# genFragments/Hadronizer/13p6TeV/DQCD_Run3/GluGluHToDarkShowers-ScenarioA_Par-ctau-0p1-mA-0p25-mpi-1_cfi.py
